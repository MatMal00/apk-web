        ...
        <div className="flex flex-col gap-1">
            ...
            <div className="flex">
                <Menu as="div" className="relative inline-block basis-24 text-left">
                    ...
                    >
                        <Menu.Items className="z-index: 10; absolute left-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                            <div className="py-1">
                                {items.map((item) => {
